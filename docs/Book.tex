...
\hypertarget{Motif}{%
\chapter{Transcription Factor Motif Finding}\label{Motif}}

\hypertarget{transcription-regulation-and-motif-representation}{%
\section{Transcription regulation and motif representation}\label{transcription-regulation-and-motif-representation}}

\hypertarget{motif-finding-using-expectation-maximization}{%
\section{Motif finding using expectation maximization}\label{motif-finding-using-expectation-maximization}}

\hypertarget{motif-finding-using-gibbs-sampler}{%
\section{Motif finding using Gibbs sampler}\label{motif-finding-using-gibbs-sampler}}

\hypertarget{gibbs-sampler-intuition-and-transcription-factor-motif-databases}{%
\section{Gibbs sampler intuition and transcription factor motif databases}\label{gibbs-sampler-intuition-and-transcription-factor-motif-databases}}

\hypertarget{motif-finding-general-practices}{%
\section{Motif finding general practices}\label{motif-finding-general-practices}}
...
\hypertarget{DNAMethyl}{%
\chapter{Epigenetics, DNA Methylation}\label{DNAMethyl}}

\hypertarget{intro-to-dna-methylation-1}{%
\section{Intro to DNA Methylation}\label{intro-to-dna-methylation-1}}

\hypertarget{dna-methylation-pattern-and-function-1}{%
\section{DNA Methylation Pattern and Function}\label{dna-methylation-pattern-and-function-1}}

\hypertarget{dna-methylation-in-diseases-1}{%
\section{DNA Methylation in Diseases}\label{dna-methylation-in-diseases-1}}

\hypertarget{techniques-to-measure-dna-methylation-1}{%
\section{Techniques to Measure DNA Methylation}\label{techniques-to-measure-dna-methylation-1}}
