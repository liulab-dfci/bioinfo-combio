...
\hypertarget{bwa-tutorial}{%
\section{BWA Tutorial}\label{bwa-tutorial}}

This BWA tutorial is made by students of past years.
...
\section{STAR tutorial}\label{star-tutorial}}

\hypertarget{salmon-tutorial}{%
\section{Salmon tutorial}\label{salmon-tutorial}}

\hypertarget{kallisto-tutorial}{%
\section{Kallisto tutorial}\label{kallisto-tutorial}}
